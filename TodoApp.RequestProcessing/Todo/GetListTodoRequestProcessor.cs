...
{
    public class GetListTodoRequestProcessor : RequestProcessor<GetListRequest, GetListResponse>
    {
        #region Fields
        ...
        public GetListTodoRequestProcessor(IDeviceManager deviceManager, IPlatformManager platformManager, ITodoManager todoManager)
